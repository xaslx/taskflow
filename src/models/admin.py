...
class TaskAdmin(ModelView, model=TaskModel):
    column_list = [TaskModel.id, TaskModel.title, TaskModel.author_id, TaskModel.assignee_id, TaskModel.status]
...
class TaskCommentAdmin(ModelView, model=TaskCommentModel):
    column_list = [TaskCommentModel.id, TaskCommentModel.task_id, TaskCommentModel.author_id, TaskCommentModel.created_at]
...
class EvaluationAdmin(ModelView, model=EvaluationModel):
    column_list = [EvaluationModel.id, EvaluationModel.user_id, EvaluationModel.evaluator_id, EvaluationModel.score]
    column_searchable_list = []
    column_sortable_list = [EvaluationModel.id, EvaluationModel.score]

class MeetingAdmin(ModelView, model=MeetingModel):
    column_list = [MeetingModel.id, MeetingModel.title, MeetingModel.organizer_id, MeetingModel.start_time, MeetingModel.end_time]
    column_searchable_list = [MeetingModel.title]
    column_sortable_list = [MeetingModel.id, MeetingModel.start_time, MeetingModel.end_time]
