...
| Метод | Маршрут           | Описание                                    | Доступ       |
| ----- | ------------------| ------------------------------------------- | ------------ |
| GET   | `/calendar/day`   | Календарь задач и встреч на конкретный день | Пользователь |
| GET   | `/calendar/month` | Календарь задач и встреч на месяц           | Пользователь |



Есть админка sqladmin по адресу **127.0.0.1:8000/admin**

Имеется минимальный фронтенд по адресу **'/'** и **'/calendar'**
